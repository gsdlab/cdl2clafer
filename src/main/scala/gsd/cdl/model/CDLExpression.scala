...
case class NEqInterfaceCount(interface:CDLExpression, count:LongIntLiteral) extends CDLExpression {
  override def toString = "#" + interface.toString + " != " + count.toString
}

case class EqInterfaceCount(interface:CDLExpression, count:LongIntLiteral) extends CDLExpression {
  override def toString = "#" + interface.toString + " == " + count.toString
}

case class LessThanInterfaceCount(interface:CDLExpression, count:LongIntLiteral) extends CDLExpression {
  override def toString = "#" + interface.toString + " < " + count.toString
}

case class LessThanOrEqInterfaceCount(interface:CDLExpression, count:LongIntLiteral) extends CDLExpression {
  override def toString = "#" + interface.toString + " <= " + count.toString
}

case class GreaterThanInterfaceCount(interface:CDLExpression, count:LongIntLiteral) extends CDLExpression {
  override def toString = "#" + interface.toString + " > " + count.toString
}

case class GreaterThanOrEqInterfaceCount(interface:CDLExpression, count:LongIntLiteral) extends CDLExpression {
  override def toString = "#" + interface.toString + " >= " + count.toString
}
